...
excel_file_path = 'playerseasondata2-21.xlsx'  # Use an Excel file for multiple sheets
...
for index, url in enumerate(urls):
    ...
    excel_path = 'playerseasondata2-21.xlsx'  # Replace with the actual path to your Excel file
    try:
    ...
    for given_name in df['Player']:  # Assuming the column name is 'Column2'
        ...
        if saved_matching_elements:
            ...
            new_variable = 'https://www.transfermarkt.com/' + first_list[1] + '/leistungsdaten/spieler/' + first_list[-1]+ "/plus/0?saison=2020"
...
# Load the workbook
workbook = openpyxl.load_workbook('playerseasondata2-21.xlsx')
...
# Save the workbook
workbook.save('playerseasondata2-21.xlsx')
