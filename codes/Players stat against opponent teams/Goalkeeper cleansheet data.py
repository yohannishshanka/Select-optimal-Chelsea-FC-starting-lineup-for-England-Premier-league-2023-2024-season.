...
excel_file_path = 'Goalkeeper cleansheet data.xlsx'  # Use an Excel file for multiple sheets
...
file_path = 'Goalkeeper cleansheet data.xlsx'
...
new_file_path = 'Goalkeeper cleansheet data.xlsx'
...
# Load the workbook
workbook = load_workbook('Goalkeeper cleansheet data.xlsx')
...
workbook.save('Goalkeeper cleansheet data.xlsx')
    ...
    for new_url, player_name in zip(new_urls, first_parts_modified_new):
       ...
       # Extract table rows
        ...
        for row in rows[1:]:
            ...
            workbook = openpyxl.load_workbook('Goalkeeper cleansheet data.xlsx')
